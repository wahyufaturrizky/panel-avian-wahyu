...
class Toko extends CI_Controller {
	...
	public function index(){
		...
		$data = [
			...
			'content' => $this->load->view('back/toko/index' ,'',true),
		];
	...
	function get_data_toko(){
		...
		$where_like['data'][] = array(
			'column' => 'id,name_shop,province,address,postal_code,handphone,telephone,email,website',
	...
	function save_toko($id=null){
		if (!$this->input->is_ajax_request()) {
			exit('No direct script access allowed');
		}

		$config['upload_path']          = './assets/picture/pic_toko/';
	...
	function do_delete($id){
		...
		$old_path = 'assets/picture/pic_toko/'.$old_img;
