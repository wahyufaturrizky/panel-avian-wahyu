...
class Informasi_Finansial extends CI_Controller {
	...
	public function index(){
		$url = [
			'0'=> base_url(),
			'1'=> "#",
			'2'=> base_url().'Informasi_Finansial/' ,
		];
		$breadcrumb = [
			'0'=>'Dashboard' ,
			'1'=>'Frontend',
		...
		$data = [
			...
			'content' => $this->load->view('back/informasi_finansial/index' ,'',true),
		];
	...
	function get_data_informasi_finansial(){
		$select = '*';
	...
	function save_informasi_finansial($id=null){
		if (!$this->input->is_ajax_request()) {
			exit('No direct script access allowed');
		}

		$config['upload_path']          = './assets/picture/pic_informasi_finansial/';
	...
	function do_delete($id){
		...
		$old_path = 'assets/picture/pic_informasi_finansial/'.$old_img;
