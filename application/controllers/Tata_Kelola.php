...
class Tata_Kelola extends CI_Controller {
	...
	public function index(){
		...
		$data = [
			...
			'content' => $this->load->view('back/tata_kelola/index' ,'',true),
		];
	...
	function save_tata_kelola($id=null){
		if (!$this->input->is_ajax_request()) {
			exit('No direct script access allowed');
		}

		$config['upload_path']          = './assets/picture/pic_tata_kelola/';
	...
	function do_delete($id){
		...
		$old_path = 'assets/picture/pic_tata_kelola/'.$old_img;
