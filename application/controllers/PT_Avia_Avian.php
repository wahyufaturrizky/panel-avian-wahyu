...
class PT_Avia_Avian extends CI_Controller {
	...
	public function index(){
		...
		$data = [
			...
			'content' => $this->load->view('back/pt_avia_avian/index' ,'',true),
		];
	...
	function get_data_pt_avia_avian(){
		$select = '*';
		...
		$where_like['data'][] = array(
			'column' => 'id,title,position,detail,requirement,additional_info,available_from_date,available_to_date,created_date,updated_date',
	...
	function save_pt_avia_avian($id=null){
		if (!$this->input->is_ajax_request()) {
			exit('No direct script access allowed');
		}

		$config['upload_path']          = './assets/picture/pic_pt_avia_avian/';
	...
	function do_delete($id){
		...
		$old_path = 'assets/picture/pic_pt_avia_avian/'.$old_img;
