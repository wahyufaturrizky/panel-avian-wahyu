<script type="text/javascript">
    ...
    function load_table(){
        $('#tbl1').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url("Berita/get_data_berita/"); ?>'
            },
            "columns": [
              {"name": "id"},
              {"name": "picture"},
    ...
    function do_edit(id){
        $.ajax({
            url: '<?= base_url() ?>Berita/get_detail/'+id,
            type: 'POST',
            dataType: 'json',
            success:function(data){ 
                ...
                $("#i_date_create").val(data.location);
                $("#img_preview").attr('src' , '<?= base_url() ?>assets/picture/pic_berita/'+data.picture);
    ...
    function edit_process(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>Berita/save_berita/'+id,
            data: data,
            dataType: 'json',
            contentType: false,
            cache: false,
    ...
    function do_delete(id){
        ...
        Swal.fire({
          ...
          if (result.value) {
            $.ajax({
                url: '<?= base_url() ?>Berita/do_delete/'+id,
                type: 'get',
                dataType: 'json',
                success:function(resp){
                     Swal.fire(
