		...
		<div class="card-box">
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="input">
					<div class="card-box">
						<h4 class="m-t-0 header-title">Input Berita Avianbrands</h4>
						<hr>
						<div class="row">
							<div class="col-12">
								<div class="p-20">
									<form class="form-horizontal" role="form" id="form1" enctype="multipart/form-data">
										...
										<div class="form-group row">
											<label class="col-2 col-form-label">Date Create</label>
											<div class="col-10">
												<input type="date" id="i_date_create" class="form-control" name="date_create" rows="8" placeholder="Please fill date create here...">
											</div>
										</div>
...
<?php $this->load->view('back/berita/js_berita') ?>