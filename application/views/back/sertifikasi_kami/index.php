		...
		<div class="card-box">
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="input">
					<div class="card-box">
						<h4 class="m-t-0 header-title">Input Sertifikasi Avianbrands</h4>
						<hr>
						<div class="row">
							<div class="col-12">
								<div class="p-20">
...
<?php $this->load->view('back/sertifikasi_kami/js_sertifikasi_kami') ?>