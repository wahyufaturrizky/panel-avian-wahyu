<script type="text/javascript">
    ...
    function load_table(){
        $('#tbl1').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url("Informasi_Finansial/get_data_informasi_finansial/"); ?>'
            },
            "columns": [
              {"name": "id"},
              {"name": "coloumn_01"},
    ...
    $("#form1").submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>Informasi_Finansial/save_informasi_finansial',
    ...
    function do_edit(id){
        $.ajax({
            url: '<?= base_url() ?>Informasi_Finansial/get_detail/'+id,
            type: 'POST',
            dataType: 'json',
    ...
    function edit_process(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>Informasi_Finansial/save_informasi_finansial/'+id,
            data: data,
            dataType: 'json',
            contentType: false,
            cache: false,
    ...
    function do_delete(id){
        ...
        Swal.fire({
          ...
          if (result.informasi_finansial) {
            $.ajax({
                url: '<?= base_url() ?>Informasi_Finansial/do_delete/'+id,
                type: 'get',
                dataType: 'json',
                success:function(resp){
                     Swal.fire(
