<script type="text/javascript">
    ...
    function load_table(){
        $('#tbl1').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url("Daftar_Aktivitas_CSR/get_data_daftar_aktivitas_csr/"); ?>'
            },
            "columns": [
              {"name": "id"},
              {"name": "picture"},
    ...
    $("#form1").submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>Daftar_Aktivitas_CSR/save_daftar_aktivitas_csr',
    ...
    function do_edit(id){
        $.ajax({
            url: '<?= base_url() ?>Daftar_Aktivitas_CSR/get_detail/'+id,
            type: 'POST',
            dataType: 'json',
            success:function(data){ 
                ...
                $("#i_location").val(data.location);
                $("#img_preview").attr('src' , '<?= base_url() ?>assets/picture/pic_daftar_aktivitas_csr/'+data.picture);
    ...
    function edit_process(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>Daftar_Aktivitas_CSR/save_daftar_aktivitas_csr/'+id,
            data: data,
            dataType: 'json',
            contentType: false,
            cache: false,
    ...
    function do_delete(id){
        ...
        Swal.fire({
          ...
          if (result.value) {
            $.ajax({
                url: '<?= base_url() ?>Daftar_Aktivitas_CSR/do_delete/'+id,
                type: 'get',
                dataType: 'json',
                success:function(resp){
                     Swal.fire(
