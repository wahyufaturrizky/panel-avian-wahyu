<div class="row">
	<div class="col-xl-12">
		<div class="card-box">
			<!-- <h4 class="header-title m-t-0 m-b-30">Daftar aktivitas CSR</h4> -->

			<ul class="nav nav-pills navtab-bg nav-justified pull-in ">
				<li class="nav-item">
					<a id="list" href="#index" data-toggle="tab" aria-expanded="false" class="nav-link active">
						<i class="fi-monitor mr-2"></i> Lihat Data Daftar aktivitas CSR
					</a>
				</li>
				<li class="nav-item">
					<a id="form" href="#input" data-toggle="tab" aria-expanded="true" class="nav-link">
						<i class="fi-head mr-2"></i> Input Data Daftar aktivitas CSR
					</a>
				</li>
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="input">
					<div class="card-box">
						<h4 class="m-t-0 header-title">Input Daftar aktivitas CSR Avianbrands</h4>
						<hr>
						<div class="row">
							<div class="col-12">
								<div class="p-20">
									<form class="form-horizontal" role="form" id="form1" enctype="multipart/form-data">
										...
										<div class="form-group row">
											...
											<div class="col-10">
												<input type="number" name="ordering" id="i_ordering" class="form-control" placeholder="Please fill with the same ID...">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-10">
												<textarea id="i_location" class="form-control" name="location" rows="8" placeholder="Please fill location here..."></textarea>
											</div>
										</div>
...
<?php $this->load->view('back/daftar_aktivitas_csr/js_daftar_aktivitas_csr') ?>