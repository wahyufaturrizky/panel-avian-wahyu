		...
		<div class="card-box">
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="input">
					<div class="card-box">
						<h4 class="m-t-0 header-title">Input Penghargaan Avianbrands</h4>
						<hr>
						<div class="row">
							<div class="col-12">
								<div class="p-20">
									<form class="form-horizontal" role="form" id="form1" enctype="multipart/form-data">
										...
										<div class="form-group row">
											<label class="col-2 col-form-label">Tahun Penghargaan</label>
											<div class="col-10">
												<textarea id="i_year" type="date" class="form-control" name="year" rows="8" placeholder="Please fill description here..."></textarea>
											</div>
										</div>
...
<?php $this->load->view('back/penghargaan/js_penghargaan') ?>