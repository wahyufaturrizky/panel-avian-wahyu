<script type="text/javascript">
    ...
    function load_table(){
        $('#tbl1').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url("Tata_Kelola/get_data_tata_kelola/"); ?>'
            },
            "columns": [
              {"name": "id"},
              {"name": "coloumn_01"},
    ...
    $("#form1").submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>Tata_Kelola/save_tata_kelola',
    ...
    function do_edit(id){
        $.ajax({
            url: '<?= base_url() ?>Tata_Kelola/get_detail/'+id,
            type: 'POST',
            dataType: 'json',
    ...
    function edit_process(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>Tata_Kelola/save_tata_kelola/'+id,
            data: data,
            dataType: 'json',
            contentType: false,
            cache: false,
    ...
    function do_delete(id){
        ...
        Swal.fire({
          ...
          if (result.tata_kelola) {
            $.ajax({
                url: '<?= base_url() ?>Tata_Kelola/do_delete/'+id,
                type: 'get',
                dataType: 'json',
                success:function(resp){
                     Swal.fire(
