<script type="text/javascript">
    ...
    function load_table(){
        $('#tbl1').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url("Siaran_Pers/get_data_siaran_pers/"); ?>'
            },
            "columns": [
              {"name": "id"},
              {"name": "picture"},
    ...
    $("#form1").submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>Siaran_Pers/save_siaran_pers',
    ...
    function do_edit(id){
        $.ajax({
            url: '<?= base_url() ?>Siaran_Pers/get_detail/'+id,
            type: 'POST',
            dataType: 'json',
            success:function(data){ 
                ...
                $("#img_preview").attr('src' , '<?= base_url() ?>assets/picture/pic_siaran_pers/'+data.picture);
    ...
    function edit_process(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>Siaran_Pers/save_siaran_pers/'+id,
            data: data,
            dataType: 'json',
            contentType: false,
            cache: false,
    ...
    function do_delete(id){
        ...
        Swal.fire({
          ...
          if (result.value) {
            $.ajax({
                url: '<?= base_url() ?>Siaran_Pers/do_delete/'+id,
                type: 'get',
                dataType: 'json',
                success:function(resp){
                     Swal.fire(
