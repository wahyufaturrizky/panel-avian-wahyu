			...
			<div id="input">
				<form class="form-horizontal" role="form" id="form1" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="card-box">
								<h4 class="m-t-0 header-title">Input Foto AIC (Avian Innovation)</h4>
								<hr>
								<div class="row">
									<div class="col-12">
										<div class="p-20">
						...
						<div class="col-md-6">
							<div class="card-box">
								<h4 class="m-t-0 header-title">Input Header & Deskripsi AIC (Avian Innovation)</h4>
								<hr>
								<div class="row">
									<div class="col-12">
										<div class="p-20">
...
<?php $this->load->view('back/aic/js_aic') ?>