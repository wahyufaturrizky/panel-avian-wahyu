...
<html lang="en">
    ...
    <body class="account-pages">
        ...
        <!-- Begin page -->
        <div class="accountbg" style="background: url('<?= base_url() ?>assets/avian/gedung.jpg');background-size: cover;background-position: center;"></div>
        ...
        <div class="wrapper-page account-page-full">
                        ...
                        <div class="card-box p-5">
                            <h2 class="text-uppercase text-center pb-4">
                                <a href="index.html" class="text-success">
                                    <span><img src="<?= base_url() ?>assets/avian/logo.png" alt="" height="26"></span>
                                </a>
                            </h2>
            ...
            <div class="m-t-40 text-center">
                <p class="account-copyright">2020 . - intivestudio.com</p>
            </div>
        ...
        <!-- Count down js -->
        <script src="<?= base_url() ?><?= base_url() ?>assets/backend/backend/plugins/count-down/jquery.lwtCountdown-1.0.js"></script>
