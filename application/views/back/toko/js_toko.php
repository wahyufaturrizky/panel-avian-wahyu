<script type="text/javascript">
    ...
    function load_table(){
        $('#tbl1').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url("Toko/get_data_toko/"); ?>'
            },
            "columns": [
              {"name": "id"},
              {"name": "name_shop"},
    ...
    function do_edit(id){
        $.ajax({
            url: '<?= base_url() ?>Toko/get_detail/'+id,
            type: 'POST',
            dataType: 'json',
            success:function(data){ 
                ...
                list_to_form();
                $("#id").val(data.id);
                $("#i_name_shop").val(data.name_shop);
    ...
    function edit_process(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>Toko/save_toko/'+id,
            data: data,
            dataType: 'json',
            contentType: false,
            cache: false,
    ...
    function do_delete(id){
        ...
        Swal.fire({
          ...
          if (result.toko) {
            $.ajax({
                url: '<?= base_url() ?>Toko/do_delete/'+id,
                type: 'get',
                dataType: 'json',
                success:function(resp){
                     Swal.fire(
