<div class="row">
	<div class="col-xl-12">
		<div class="card-box">
			<!-- <h4 class="header-title m-t-0 m-b-30">Tirtakencana Tatawarna</h4> -->

			<ul class="nav nav-pills navtab-bg nav-justified pull-in ">
				<li class="nav-item">
					<a id="list" href="#index" data-toggle="tab" aria-expanded="false" class="nav-link active">
						<i class="fi-monitor mr-2"></i> Lihat Data Tirtakencana Tatawarna
					</a>
				</li>
				<li class="nav-item">
					<a id="form" href="#input" data-toggle="tab" aria-expanded="true" class="nav-link">
						<i class="fi-head mr-2"></i> Input Data Tirtakencana Tatawarna
					</a>
				</li>
			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="input">
					<div class="card-box">
						<h4 class="m-t-0 header-title">Input Tirtakencana Tatawarna Avianbrands</h4>
						<hr>
						<div class="row">
							<div class="col-12">
								<div class="p-20">
									<form class="form-horizontal" role="form" id="form1" enctype="multipart/form-data">
										...
										<div class="form-group row">
											<label class="col-2 col-form-label">Title Job Tirtakencana Tatawarna</label>
											<div class="col-10">
										...
										<div class="form-group row">
											<label class="col-2 col-form-label">Position Tirtakencana Tatawarna</label>
											<div class="col-10">
										...
										<div class="form-group row">
											...
											<div class="col-10">
												<input type="date" id="i_available_from_date" class="form-control" name="available_from_date"
													rows="8" placeholder="Please fill date create here...">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-10">
												<input type="date" id="i_available_to_date" class="form-control" name="available_to_date"
													rows="8" placeholder="Please fill date create here...">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-10">
												<input type="date" id="i_created_date" class="form-control" name="created_date" rows="8"
													placeholder="Please fill date create here...">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-10">
												<input type="date" id="i_updated_date" class="form-control" name="updated_date" rows="8"
													placeholder="Please fill date create here...">
											</div>
										</div>
...
<?php $this->load->view('back/tirtakencana_tatawarna/js_tirtakencana_tatawarna') ?>